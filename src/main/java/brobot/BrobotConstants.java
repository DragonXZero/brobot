...
public class BrobotConstants {
    ...
    public static final String MUDAE_PREFIX = "m";
    public static final String MARKOV_COMMAND_PREFIX = "markov";
    public static final String MARKOV_COMMAND_PREFIX_SHORTCUT = "ma";
